...
We support the [Göttingen State and University Library](https://www.sub.uni-goettingen.de/sub-aktuell/) and the [University of Göttingen](https://www.uni-goettingen.de/) by providing data-driven insights into current trends in scholarly communication.

On our blog, we share initial data case studies based on open metadata. For more info about us, see [here](about.qmd).
