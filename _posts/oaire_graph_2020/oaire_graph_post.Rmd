...
# Does R do that internally? I assume how well this works depends on the system conditions, maybe a link to where this is described could  it?
...
A note on performance: Parsing the whole dump `h2020_results` using these parsers took me around 2 hours.
# With what kind of system? That will influence the time needed.
...
About 77% of research publications under the H2020 open access mandate are openly available. Figure \@ref(fig:variations) highlights a generally high rate of compliance with the open access mandate. However, uptake levels vary among and within the H2020 funding programme. 
...
# How does knowing how  projects compare with others funded by the same institutions help to help grantees make their own work open access? To my knowledge the availability of outlets of acceptable quality for publication is highly field specific and I don't really see how the funder comes into play, unless funders only fund certain fields.
