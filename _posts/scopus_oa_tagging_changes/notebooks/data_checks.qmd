...
```{r}
save(upw_0407_recopy,file = here("_posts/scopus_oa_tagging_changes/data","upw_0407_recopy.RData"))
save(upw_0407_host,file = here("_posts/scopus_oa_tagging_changes/data","upw_0407_host.RData"))
```
...
```{r}
save(upw_0710_recopy,file = here("_posts/scopus_oa_tagging_changes/data","upw_0710_recopy.RData"))
save(upw_0710_host,file = here("_posts/scopus_oa_tagging_changes/data","upw_0710_host.RData"))
```

# SQl Abfragen für den check der 10 dois gegen scp_rep
