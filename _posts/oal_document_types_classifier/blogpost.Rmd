...
description: Although OpenAlex has revised its document types in the past, there is still room for improvement. In this blog post, I introduce a document type classifier that reduces the number of research items that are incorrectly classified as articles or reviews in OpenAlex. 
author:
  - name: Nick Haupka 
...
To evaluate the classification model, I will compare the results of my classifier with OpenAlex, the [CWTS Open Leiden Ranking](https://open.leidenranking.com) and Scopus. For the comparison I used the August and September 2024 snapshot from OpenAlex, the July 2024 snapshot from Scopus and the 2024 snapshot from the CWTS.
