...
In order to avoid potentially discriminatory behaviour of my classifier, I will analyse the impact of my classifier on topics in OpenAlex (see Figure \@ref(fig:topics)). The grey bar in the figure shows the proportion of publications excluded by the procedures. Again, I will compare the results with the CWTS to investigate differences. The figure shows that my classifier treats publications from different topics in a similar way, while the CWTS method excludes publications from the social sciences more frequently. This could be due to the fact that there is possibly less communication in English in the social sciences (the core items only contain English publications) or that metadata coverage is less pronounced in the social sciences. 

```{r topics, echo=FALSE, layout='l-page', fig.cap='Topics'}
