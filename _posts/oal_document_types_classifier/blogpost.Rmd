...
If you want to check out the classifier you can visit our [Google BigQuery instance]() where I uploaded my results. Here, you can also compare it with OpenAlex, Crossref and Semantic Scholar. To query it, you can use:
