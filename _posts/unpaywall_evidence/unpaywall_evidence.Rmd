...
plot_b <-
  ...
  theme(panel.border = element_blank())
# turn ggplot object into interactive plotly chart
plotly::ggplotly(plot_b, tooltip = c("y", "x")) 
```
...
#create interactive plot
plotly::ggplotly(plot_ev_types_per_year, tooltip = c("y", "x")) -> plotlyfacetfig
...
plot_host_intersect <-
  ...
  theme(panel.border = element_blank())
# turn ggplot object into interactive plotly chart
plotly::ggplotly(plot_host_intersect, tooltip = c("y", "x")) 
```
