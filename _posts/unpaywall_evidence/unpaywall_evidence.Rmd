...
```{r, layout = "l-page", fig.cap="Possible Values of Evidence Type Field."}
...
```{r, layout = "l-page", fig.cap = "Number of Articles per Evidence Type. Least frequent evidence types are collated as category `Other`."}
