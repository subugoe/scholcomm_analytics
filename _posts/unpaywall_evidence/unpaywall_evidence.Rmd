...
names(evidence_categories_upset_list) <- evidence_categories_upset_list$ev_cat
# convert to vector
evidence_categories_upset_expr <- unlist(evidence_categories_upset_list)
upset(evidence_categories_upset_expr, nsets = 7, nintersects = 15, order.by = "freq", show.numbers = FALSE)
```
